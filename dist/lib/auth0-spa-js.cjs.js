...
class Auth0Client {
    constructor(options) {
        ...
        this.authorizeDomainUrl = getDomain((_a = this.options.authorizeDomain) !== null && _a !== void 0 ? _a : this.options.domain);
    ...
    _buildLogoutUrl(options) {
        ...
        const url = this._url(`${this.domainUrl}/v2/logout?${createQueryParams(Object.assign({
